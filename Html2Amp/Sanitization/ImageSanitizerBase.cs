...
{
	public class ImageSanitizerBase : MediaSanitizer
	{
		...
		public override IElement Sanitize(IDocument document, IElement htmlElement)
		{
			...
			return this.SanitizeCore<IHtmlImageElement>(document, htmlElement, this.GetAmpElementTag());
		}

		protected internal virtual string GetAmpElementTag()
		{
			return "amp-img";
		}
